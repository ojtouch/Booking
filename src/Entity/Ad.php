...
class Ad
{
     ...
     * @Assert\Length(min=10, max=255, minMessage="Le titre doit faire plus de 10 caractères", maxMessage="Le titre ne doit pas excéder 255 caractères")
     */
    private $title;
    ...
    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100, minMessage="Votre déscription doit faire plus de 100 caractères")
     */
    private $contenu;
